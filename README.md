...
When the original function is: <img src="https://latex.codecogs.com/svg.image?Y = \frac{1}{2}X^{2}&space;&plus;&space;3X&space;&plus;&space;2" title="\frac{1}{2}X^{2} + 3X + 2" />
